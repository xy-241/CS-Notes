...
- $\binom{n}{k}$ is the [[Binomial Coefficient]] that calculates the **total number of [[Combination]]** of a certain **composition of success and failures**, the **specific outcome** refers to this particular composition of success and failures
...
- [A Secret Weapon for Predicting Outcomes: The Binomial Distribution - YouTube](https://youtu.be/6YzrVUVO9M0?si=pPJB61fYJ2vKoryn)