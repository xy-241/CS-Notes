...
Last Date: 2025-08-04T18:30:56+08:00
References: 
draft: 
...
## Out of Memory
---
- This happens when systems runs of usable RAM and cant satisfy memory allocation requests, not even by killing [[#Memory Cache]] or [[Swap Space|swapping]]. At this point, [[Kernel]] is forced to kill one or more [[Process (进程)|processes]] to free up memory
