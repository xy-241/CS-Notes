...
Last Date: 2025-05-19T13:03:42+08:00
References: 
draft: 
...
> 
> **Mounting support**: VFS lets you mount a FAT32 USB stick onto a system running ext4. Internally, VFS routes the [[System Call (系统调用)|system calls]] to the correct [[Device Controller#Device Driver|file system driver]]
...
3. **VFS Layer**:
	...
	- Traverses directories to locate the [[File|file]]
4. **Filesystem Specific Operations**:
	- Relevant [[Device Controller#Device Driver|filesystem driver]] handles the request
	- Creates or finds [[Inode|inode]] for the file
5. **Vnode Creation**:
	- Creates a vnode representing the file
...
7. **File Descriptor Allocation**:
	- Finds lowest unused FD in **process table**
...
> 
> When a [[File System|filesystem]] is mounted, it registers these functions with the [[VFS]]. As files are accessed, their vnode entries are populated with pointers to the appropriate functions. 
