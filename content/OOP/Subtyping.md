...
Last Date: 2025-08-26T16:16:25+08:00
References:
---
## Abstract
---
...
> 
> At compile time, the compile-time type is identified, and the [[Function#Java Function Descriptor|method descriptor]] in the compile-time type is stored in the generated bytecode. When the runtime type is determined during runtime, Java then looks for an accessible method with a matching descriptor in that runtime type.
